"""
ItemCategory API - REST Endpoints con documentación Swagger completa
"""
...
item_category_api = Blueprint('item_category_api', __name__, url_prefix='/api/categorías')
...
def get_by_id(id):
    ...
    parameters:
      - name: id
        ...
        type: integer
        required: true
        description: ID del categoría
    responses:
      200:
        description: ItemCategory encontrado
        schema:
          type: object
          properties:
            success:
            ...
            data:
              $ref: '#/definitions/ItemCategory'
      404:
        description: ItemCategory no encontrado
      401:
        description: No autenticado
      500:
        description: Error del servidor
    ...
    try:
        ...
        return error_response('ItemCategory no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
...
def create():
    ...
    responses:
      201:
        description: ItemCategory creado exitosamente
        schema:
          type: object
          properties:
            success:
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'ItemCategory creado exitosamente', 201)
...
def update(id):
    ...
    responses:
      200:
        description: ItemCategory actualizado exitosamente
        schema:
          type: object
          properties:
            success:
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'ItemCategory actualizado exitosamente')
    except ValueError as e:
...
def delete(id):
    ...
    parameters:
      - name: id
        ...
        type: integer
        required: true
        description: ID del categoría a eliminar
    responses:
      200:
        description: ItemCategory eliminado exitosamente
        schema:
          type: object
          properties:
            success:
    ...
    try:
        ...
        if deleted:
            return success_response(message='ItemCategory eliminado exitosamente')
        return error_response('ItemCategory no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
