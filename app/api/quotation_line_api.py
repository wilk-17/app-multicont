"""
QuotationLine API - REST Endpoints
"""
from flask import Blueprint, request, jsonify
from app.use_cases.quotation_line_handler import QuotationLineHandler

quotation_line_api = Blueprint('quotation_line_api', __name__, url_prefix='/api/quotation_lines')
handler = QuotationLineHandler()

@quotation_line_api.route('/', methods=['GET'])
def get_all():
    """Lista todos los quotation lines con paginación"""
    try:
