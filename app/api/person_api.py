...
def get_by_id(id):
    ...
    try:
        ...
        return error_response('Persona no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
...
def create():
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'Persona creado exitosamente', 201)
...
def update(id):
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'Persona actualizado exitosamente')
    except ValueError as e:
...
def delete(id):
    ...
    try:
        ...
        if deleted:
            return success_response(message='Persona eliminado exitosamente')
        return error_response('Persona no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
