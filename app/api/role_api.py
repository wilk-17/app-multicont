"""
Role API - REST Endpoints con documentación Swagger completa
"""
...
def get_by_id(id):
    ...
    try:
        ...
        return error_response('Role no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
...
def create():
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'Role creado exitosamente', 201)
...
def update(id):
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'Role actualizado exitosamente')
    except ValueError as e:
...
def delete(id):
    ...
    responses:
      200:
        description: Role eliminado exitosamente
        schema:
          type: object
          properties:
            success:
    ...
    try:
        ...
        if deleted:
            return success_response(message='Role eliminado exitosamente')
        return error_response('Role no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
