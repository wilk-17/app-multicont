...
state_api = Blueprint('state_api', __name__, url_prefix='/api/states')
...
def get_by_id(id):
    ...
    try:
        ...
        return error_response('Estado no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
...
def create():
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'Estado creado exitosamente', 201)
...
def update(id):
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'Estado actualizado exitosamente')
    except ValueError as e:
