"""
State API - REST Endpoints con documentación Swagger completa
"""
...
state_api = Blueprint('state_api', __name__, url_prefix='/api/estados')
...
@state_api.route('/<int:id>', methods=['GET'])
@jwt_required()
...
def get_by_id(id):
    ...
    try:
        ...
        return error_response('State no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
...
def create():
    ...
    responses:
      201:
        description: State creado exitosamente
        schema:
          type: object
          properties:
            success:
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'State creado exitosamente', 201)
    except ValueError as e:
        return error_response(str(e), 400)
    except Exception as e:
        return error_response(str(e), 500)

@state_api.route('/<int:id>', methods=['PUT'])
@jwt_required()
@require_role('ADMIN', 'MANAGER')
def update(id):
    """
    ...
    responses:
      200:
        description: State actualizado exitosamente
        schema:
          type: object
          properties:
            success:
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'State actualizado exitosamente')
    except ValueError as e:
        return error_response(str(e), 404)
    except Exception as e:
        return error_response(str(e), 500)

@state_api.route('/<int:id>', methods=['DELETE'])
@jwt_required()
@require_role('ADMIN')
def delete(id):
    """
    ...
    responses:
      200:
        description: State eliminado exitosamente
        schema:
          type: object
          properties:
            success:
    ...
    try:
        ...
        if deleted:
            return success_response(message='State eliminado exitosamente')
        return error_response('State no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
