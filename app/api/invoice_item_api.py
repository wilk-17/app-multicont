"""
InvoiceItem API - REST Endpoints
"""
from flask import Blueprint, request, jsonify
from app.use_cases.invoice_item_handler import InvoiceItemHandler

invoice_item_api = Blueprint('invoice_item_api', __name__, url_prefix='/api/invoice_items')
handler = InvoiceItemHandler()

@invoice_item_api.route('/', methods=['GET'])
def get_all():
    """Lista todos los invoice items con paginación"""
    try:
