...
def get_by_id(id):
    ...
    try:
        ...
        return error_response('Permiso no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
...
def create():
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'Permiso creado exitosamente', 201)
...
def update(id):
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'Permiso actualizado exitosamente')
    except ValueError as e:
...
def delete(id):
    ...
    try:
        ...
        if deleted:
            return success_response(message='Permiso eliminado exitosamente')
        return error_response('Permiso no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
