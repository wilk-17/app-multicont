...
quote_item_api = Blueprint('quote_item_api', __name__, url_prefix='/api/quote-items')
...
def get_all():
    """Lista todos los item de cotizacións con paginación"""
    try:
...
def get_by_id(id):
    ...
    try:
        ...
        return error_response('Item de cotización no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
...
def create():
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'Item de cotización creado exitosamente', 201)
...
def update(id):
    ...
    try:
        ...
        return success_response(obj.to_dict(), 'Item de cotización actualizado exitosamente')
    except ValueError as e:
...
def delete(id):
    ...
    try:
        ...
        if deleted:
            return success_response(message='Item de cotización eliminado exitosamente')
        return error_response('Item de cotización no encontrado', 404)
    except Exception as e:
        return error_response(str(e), 500)
