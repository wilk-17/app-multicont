"""
SalesOrderItem API - REST Endpoints
"""
from flask import Blueprint, request, jsonify
from app.use_cases.sales_order_item_handler import SalesOrderItemHandler

sales_order_item_api = Blueprint('sales_order_item_api', __name__, url_prefix='/api/sales_order_items')
handler = SalesOrderItemHandler()

@sales_order_item_api.route('/', methods=['GET'])
def get_all():
    """Lista todos los sales order items con paginación"""
    try:
